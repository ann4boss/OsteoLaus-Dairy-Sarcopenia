...
SENTINEL_NUMERIC <- list(
    ...
    agediagcmp = 99L,  # 99 = "does not know" age at diagnosis of comorbidity
    agediaghdc  = 99L,   # 99 = "does not know" age at diagnosis of heart disease
    agediagchf  = 99L,   # 99 = "does not know" age at diagnosis of CHF
    agediagartm  = 99L,   # 99 = "does not know" age at diagnosis of arthritis
    agediagcad  = 99L,   # 99 = "does not know" age at diagnosis of coronary artery disease
    agediagangn  = 99L,   # 99 = "does not know" age at diagnosis of gangrene
    agediagmiac  = 99L,   # 99 = "does not know" age at diagnosis of myocardial infarction/angina
    agediagstrok  = 99L,   # 99 = "does not know" age at diagnosis of stroke
    agediagvslg  = 99L,   # 99 = "does not know" age at diagnosis of vascular disease
    agediagccth  = 99L,   # 99 = "does not know" age at diagnosis of cataract
    agediagcabg  = 99L,   # 99 = "does not know" age at diagnosis of CABG
    agediagpcin  = 99L,   # 99 = "does not know" age at diagnosis of PCI
    agediag_dbts  = 99L   # 99 = "does not know" age at diagnosis of diabetes
...
#' unchanged.
#'
#' This is a general utility that can be used for visit-based prefixes
